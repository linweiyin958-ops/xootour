...
def main():
    parser = argparse.ArgumentParser(description="Batch LLM supplement for Liuzhou stores")
    ...
    parser.add_argument("--db", type=str, default="output/xootour_liuzhou.db", help="Database path")
