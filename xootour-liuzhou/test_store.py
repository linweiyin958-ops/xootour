"""Quick test: crawl a few Liuzhou stores to verify the pipeline works."""
...
from scraper.config import OUTPUT_DIR, DATA_DIR, LIUZHOU_CITY_ID, LIUZHOU_DISTRICTS, AMAP_API_KEY
...
logger.info(f"LIUZHOU_CITY_ID={LIUZHOU_CITY_ID}")
logger.info(f"Districts: {len(LIUZHOU_DISTRICTS)}")
