-- ============================================================
-- XOOTOUR Liuzhou Database Schema
-- 景点系统 + 5大品类门店系统（美食/酒店/景点/购物/娱乐）
-- ============================================================

CREATE DATABASE IF NOT EXISTS `xootour_liuzhou` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE `xootour_liuzhou`;
...
CREATE TABLE `tour_spot` (
    ...
    `city_id` INT NOT NULL DEFAULT 10 COMMENT '城市ID(柳州=10)',
...
(1, '美食', 'Food', 1, '柳州美食门店，覆盖螺蛳粉/牛杂/鸭脚煲/特色小吃及各地菜系'),
(2, '酒店', 'Hotel', 2, '柳州住宿服务，覆盖星级酒店/江景民宿/度假村/青年旅舍'),
(3, '景点', 'Attraction', 3, '柳州旅游景点，覆盖4A景区/博物馆/公园/民族村寨/主题乐园'),
(4, '购物', 'Shopping', 4, '柳州购物场所，覆盖商圈百货/特色街区/特产店/文创市集'),
(5, '娱乐', 'Entertainment', 5, '柳州娱乐场所，覆盖酒吧/KTV/密室/剧本杀/演出/水疗');
