...
def main():
    parser = argparse.ArgumentParser(description="Batch LLM supplement for Chengdu stores")
    ...
    parser.add_argument("--db", type=str, default="output/xootour_chengdu.db", help="Database path")
