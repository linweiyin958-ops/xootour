"""Quick test: crawl a few Chengdu stores to verify the pipeline works."""
...
from scraper.config import OUTPUT_DIR, DATA_DIR, CHENGDU_CITY_ID, CHENGDU_DISTRICTS, AMAP_API_KEY
...
logger.info(f"CHENGDU_CITY_ID={CHENGDU_CITY_ID}")
logger.info(f"Districts: {len(CHENGDU_DISTRICTS)}")
