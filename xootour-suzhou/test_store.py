"""Quick test: crawl a few Suzhou stores to verify the pipeline works."""
...
from scraper.config import OUTPUT_DIR, DATA_DIR, SUZHOU_CITY_ID, SUZHOU_DISTRICTS, AMAP_API_KEY
...
logger.info(f"SUZHOU_CITY_ID={SUZHOU_CITY_ID}")
logger.info(f"Districts: {len(SUZHOU_DISTRICTS)}")
