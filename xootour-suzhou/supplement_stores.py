...
def main():
    parser = argparse.ArgumentParser(description="Batch LLM supplement for Suzhou stores")
    ...
    parser.add_argument("--db", type=str, default="output/xootour_suzhou.db", help="Database path")
