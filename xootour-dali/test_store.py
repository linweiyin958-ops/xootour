"""Quick test: crawl a few Dali stores to verify the pipeline works."""
...
from scraper.config import OUTPUT_DIR, DATA_DIR, DALI_CITY_ID, DALI_DISTRICTS, AMAP_API_KEY
...
logger.info(f"DALI_CITY_ID={DALI_CITY_ID}")
logger.info(f"Districts: {len(DALI_DISTRICTS)}")
