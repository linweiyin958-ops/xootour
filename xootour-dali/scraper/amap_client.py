...
class AmapClient:
    ...
    def geocode(self, address: str, city: str = "大理") -> Optional[dict]:
    ...
    def search_poi(self, keywords: str, city: str = "大理", citylimit: bool = True) -> Optional[dict]:
        ...
        try:
            ...
            if data.get("status") == "1" and data.get("pois"):
                ...
                return {
                    ...
                    "lat": lat,
                    "lng": lng,
                    "district": poi.get("pname", "") + poi.get("cityname", "").replace("大理市", "").replace("大理白族自治州", ""),
