"""Quick test: crawl a few Beijing stores to verify the pipeline works."""
...
from scraper.config import OUTPUT_DIR, DATA_DIR, CHONGQING_CITY_ID, CHONGQING_DISTRICTS, AMAP_API_KEY
...
logger.info(f"CHONGQING_CITY_ID={CHONGQING_CITY_ID}")
logger.info(f"Districts: {len(CHONGQING_DISTRICTS)}")
