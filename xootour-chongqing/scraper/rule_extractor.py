...
from .config import CHONGQING_CITY_ID, CHONGQING_DISTRICTS
...
class RuleExtractor:
    def extract_spot(
        ...
        if l1["name_zh"] and l1["name_en"]:
            l1["seo_desc"] = f"{l1['name_zh']}({l1['name_en']})重庆旅游指南 - 游玩攻略、开放时间、交通路线"
        elif l1["name_zh"]:
            l1["seo_desc"] = f"{l1['name_zh']}重庆旅游指南 - 游玩攻略、开放时间、交通路线"
    ...
    def extract_store(
        ...
        if l1["name_zh"] and l1["name_en"]:
            l1["seo_desc"] = f"{l1['name_zh']}({l1['name_en']})-{cat_name}重庆旅游服务指南"
        elif l1["name_zh"]:
            l1["seo_desc"] = f"{l1['name_zh']}-{cat_name}重庆旅游服务指南"
