...
from .config import OUTPUT_DIR, CHONGQING_CITY_ID
...
class SQLiteWriter:
    def __init__(self, db_path: str = None):
        if not db_path:
            db_path = os.path.join(OUTPUT_DIR, "xootour_chongqing.db")
    ...
    def write_spot_data(self, spot_id: int, data: dict):
        ...
        self._exec(
            ...
            (spot_id, l1.get("name_zh"), l1.get("name_en"), l1.get("city_id", CHONGQING_CITY_ID),
    ...
    def write_store_data(self, store_id: int, data: dict):
        ...
        self._exec(
            ...
            (store_id,
             ...
             self._to_scalar(l1.get("city_id", CHONGQING_CITY_ID)),
