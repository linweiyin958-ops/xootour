...
from .config import DB_HOST, DB_PORT, DB_USER, DB_PASSWORD, DB_NAME, DB_CHARSET, WUHAN_CITY_ID
...
class DBWriter:
    ...
    def insert_tour_spot(self, data: dict) -> Optional[int]:
        ...
        params = (
            ...
            data.get("name"),
            data.get("subtitle"),
            data.get("city_id", WUHAN_CITY_ID),
            data.get("cover_img"),
            data.get("seo_desc"),
    ...
    def write_spot_data(self, spot_id: int, structured_data: dict):
        ...
        self.insert_tour_spot({
            ...
            "city_id": l1.get("city_id", WUHAN_CITY_ID),
