"""Quick test: crawl a few Wuhan stores to verify the pipeline works."""
...
from scraper.config import OUTPUT_DIR, DATA_DIR, WUHAN_CITY_ID, WUHAN_DISTRICTS, AMAP_API_KEY
...
logger.info(f"WUHAN_CITY_ID={WUHAN_CITY_ID}")
logger.info(f"Districts: {len(WUHAN_DISTRICTS)}")
