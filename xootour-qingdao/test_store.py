"""Quick test: crawl a few Qingdao stores to verify the pipeline works."""
...
from scraper.config import OUTPUT_DIR, DATA_DIR, QINGDAO_CITY_ID, QINGDAO_DISTRICTS, AMAP_API_KEY
...
logger.info(f"QINGDAO_CITY_ID={QINGDAO_CITY_ID}")
logger.info(f"Districts: {len(QINGDAO_DISTRICTS)}")
