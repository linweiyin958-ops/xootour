...
class AmapClient:
    ...
    def geocode(self, address: str, city: str = "青岛") -> Optional[dict]:
    ...
    def search_poi(self, keywords: str, city: str = "青岛", citylimit: bool = True) -> Optional[dict]:
        ...
        try:
            ...
            if data.get("status") == "1" and data.get("pois"):
                ...
                return {
                    ...
                    "lat": lat,
                    "lng": lng,
                    "district": poi.get("pname", "") + poi.get("cityname", "").replace("青岛市", ""),
