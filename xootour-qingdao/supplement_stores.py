...
def main():
    parser = argparse.ArgumentParser(description="Batch LLM supplement for Qingdao stores")
    ...
    parser.add_argument("--db", type=str, default="output/xootour_qingdao.db", help="Database path")
