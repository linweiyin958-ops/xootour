-- ============================================================
-- XOOTOUR Qingdao Database Schema
-- 景点系统 + 5大品类门店系统（美食/酒店/景点/购物/娱乐）
-- ============================================================

CREATE DATABASE IF NOT EXISTS `xootour_qingdao` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE `xootour_qingdao`;
...
CREATE TABLE `tour_spot` (
    ...
    `city_id` INT NOT NULL DEFAULT 2 COMMENT '城市ID(青岛=2)',
...
(1, '美食', 'Food', 1, '青岛美食门店，覆盖海鲜/鲁菜/啤酒屋/韩料/小吃及各地菜系'),
(2, '酒店', 'Hotel', 2, '青岛住宿服务，覆盖星级酒店/海景民宿/公寓/青年旅舍/度假村'),
(3, '景点', 'Attraction', 3, '青岛旅游景点，覆盖A级景区/博物馆/公园/海滩/海岛/主题乐园'),
(4, '购物', 'Shopping', 4, '青岛购物场所，覆盖商圈百货/商业街/海鲜市场/特产店'),
(5, '娱乐', 'Entertainment', 5, '青岛娱乐场所，覆盖酒吧/KTV/洗浴/温泉/电影院/水世界');
