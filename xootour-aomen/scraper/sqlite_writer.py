...
class SQLiteWriter:
    def __init__(self, db_path: str = None):
        if not db_path:
            db_path = os.path.join(OUTPUT_DIR, "xootour_aomen.db")
    ...
    def write_spot_data(self, spot_id: int, data: dict):
        ...
        self._exec(
            ...
            (spot_id, l1.get("name_zh"), l1.get("name_en"), l1.get("city_id", MACAU_CITY_ID),
        ...
        if packages:
            ...
            self._exec_many(
                ...
                [(spot_id, p.get("package_name"), p.get("price"), p.get("description"), p.get("currency", "MOP")) for p in packages]
            )
    ...
    def write_store_data(self, store_id: int, data: dict):
        ...
        self._exec(
            ...
            (store_id,
             ...
             self._to_scalar(l1.get("city_id", MACAU_CITY_ID)),
            ...
            for p in products:
                self._insert_and_get_id(
                    ...
                    (store_id, self._to_scalar(p.get("product_name")), self._to_scalar(p.get("price")),
                     self._to_scalar(p.get("description")), self._to_scalar(p.get("currency", "MOP")),
