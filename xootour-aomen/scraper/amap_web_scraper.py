...
class AmapWebScraper:
    ...
    def _normalize_poi(self, poi: dict) -> Optional[dict]:
        ...
        if not district and pname:
            ...
            if pname and pname != cityname:
                district = pname + cityname.replace("澳门", "")
    ...
    def _amap_search(self, keyword: str, city: str = "澳门") -> Optional[dict]:
        self._delay()
        try:
            params = {
                "query": keyword,
    ...
    def _nominatim_search(self, name: str, city: str = "Macau") -> Optional[dict]:
        self._delay()
        try:
            params = {
                "q": f"{name}, {city}",
    ...
    def search_pois(self, keyword: str, city: str = "澳门", max_count: int = 25) -> List[dict]:
