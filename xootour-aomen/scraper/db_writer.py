...
from .config import DB_HOST, DB_PORT, DB_USER, DB_PASSWORD, DB_NAME, DB_CHARSET, MACAU_CITY_ID
...
class DBWriter:
    ...
    def insert_tour_spot(self, data: dict) -> Optional[int]:
        ...
        params = (
            ...
            data.get("name"),
            data.get("subtitle"),
            data.get("city_id", MACAU_CITY_ID),
            data.get("cover_img"),
            data.get("seo_desc"),
    ...
    def insert_tour_spot_packages(self, spot_id: int, packages: list):
        ...
        params_list = [(spot_id, p.get("package_name"), p.get("price"), p.get("description"), p.get("currency", "MOP")) for p in packages]
        self.execute_many(sql, params_list)
    ...
    def write_spot_data(self, spot_id: int, structured_data: dict):
        ...
        self.insert_tour_spot({
            ...
            "city_id": l1.get("city_id", MACAU_CITY_ID),
    ...
    def insert_store_products(self, store_id: int, products: list):
        ...
        for p in products:
            ...
            params = (
                ...
                p.get("currency", "MOP"), p.get("is_signature", False), p.get("sort_order", 0),
            )
