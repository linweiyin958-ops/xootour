"""Quick test: crawl a few Hangzhou stores to verify the pipeline works."""
...
from scraper.config import OUTPUT_DIR, DATA_DIR, HANGZHOU_CITY_ID, HANGZHOU_DISTRICTS, AMAP_API_KEY
...
logger.info(f"HANGZHOU_CITY_ID={HANGZHOU_CITY_ID}")
logger.info(f"Districts: {len(HANGZHOU_DISTRICTS)}")
