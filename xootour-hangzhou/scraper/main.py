...
from .config import DATA_DIR, OUTPUT_DIR, HANGZHOU_CITY_ID, AMAP_API_KEY
...
def run_pipeline(spots: list, start_id: int = 1,
    ...
    try:
        ...
        for idx, spot in enumerate(spots):
            ...
            structured_data["L1_base_and_info"]["city_id"] = HANGZHOU_CITY_ID
...
def main():
    parser = argparse.ArgumentParser(description="XOOTOUR Hangzhou Tourist Spots Data Scraper")
