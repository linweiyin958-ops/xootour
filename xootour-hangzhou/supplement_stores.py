...
def main():
    parser = argparse.ArgumentParser(description="Batch LLM supplement for Hangzhou stores")
    ...
    parser.add_argument("--db", type=str, default="output/xootour_hangzhou.db", help="Database path")
