"""Quick test: crawl a few Xiamen stores to verify the pipeline works."""
...
from scraper.config import OUTPUT_DIR, DATA_DIR, XIAMEN_CITY_ID, XIAMEN_DISTRICTS, AMAP_API_KEY
...
logger.info(f"XIAMEN_CITY_ID={XIAMEN_CITY_ID}")
logger.info(f"Districts: {len(XIAMEN_DISTRICTS)}")
