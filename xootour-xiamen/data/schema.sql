-- ============================================================
-- XOOTOUR xiamen Database Schema
-- 景点系统 + 5大品类门店系统（美食/酒店/景点/购物/娱乐）
-- ============================================================

CREATE DATABASE IF NOT EXISTS `xootour_xiamen` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE `xootour_xiamen`;
...
CREATE TABLE `tour_spot` (
    ...
    `city_id` INT NOT NULL DEFAULT 1 COMMENT '城市ID(厦门=1)',
...
(1, '美食', 'Food', 1, '厦门美食门店，覆盖京菜/烤鸭/涮羊肉/小吃/老字号及各地菜系'),
(2, '酒店', 'Hotel', 2, '厦门住宿服务，覆盖星级酒店/四合院民宿/胡同客栈/青年旅舍'),
(3, '景点', 'Attraction', 3, '厦门旅游景点，覆盖5A/4A景区/博物馆/公园/寺庙/胡同/主题乐园'),
(4, '购物', 'Shopping', 4, '厦门购物场所，覆盖商圈百货/特色街区/免税店/文创市集'),
(5, '娱乐', 'Entertainment', 5, '厦门娱乐场所，覆盖酒吧/KTV/密室/剧本杀/演出/相声/夜店');
