...
def main():
    parser = argparse.ArgumentParser(description="Batch LLM supplement for Xiamen stores")
    ...
    parser.add_argument("--db", type=str, default="output/xootour_xiamen.db", help="Database path")
