"""Quick test: crawl a few Xi'an stores to verify the pipeline works."""
...
from scraper.config import OUTPUT_DIR, DATA_DIR, XIAN_CITY_ID, XIAN_DISTRICTS, AMAP_API_KEY
...
logger.info(f"XIAN_CITY_ID={XIAN_CITY_ID}")
logger.info(f"Districts: {len(XIAN_DISTRICTS)}")
