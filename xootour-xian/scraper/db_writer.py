...
from .config import DB_HOST, DB_PORT, DB_USER, DB_PASSWORD, DB_NAME, DB_CHARSET, XIAN_CITY_ID
...
class DBWriter:
    ...
    def write_spot_data(self, spot_id: int, structured_data: dict):
        ...
        self.insert_tour_spot({
            ...
            "city_id": l1.get("city_id", XIAN_CITY_ID),
