...
def main():
    parser = argparse.ArgumentParser(description="Batch LLM supplement for Sanya stores")
    ...
    parser.add_argument("--db", type=str, default="output/xootour_sanya.db", help="Database path")
