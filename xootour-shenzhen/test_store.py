...
from scraper.config import OUTPUT_DIR, DATA_DIR, SHENZHEN_CITY_ID, SHENZHEN_DISTRICTS, AMAP_API_KEY
...
logger.info(f"SHENZHEN_CITY_ID={SHENZHEN_CITY_ID}")
logger.info(f"Districts: {len(SHENZHEN_DISTRICTS)}")
