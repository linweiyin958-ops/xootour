...
def main():
    parser = argparse.ArgumentParser(description="Batch LLM supplement for Shenzhen stores")
    ...
    parser.add_argument("--db", type=str, default="output/xootour_shenzhen.db", help="Database path")
