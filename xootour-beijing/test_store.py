...
from scraper.config import OUTPUT_DIR, DATA_DIR, BEIJING_CITY_ID, BEIJING_DISTRICTS, AMAP_API_KEY
...
logger.info(f"BEIJING_CITY_ID={BEIJING_CITY_ID}")
logger.info(f"Districts: {len(BEIJING_DISTRICTS)}")
