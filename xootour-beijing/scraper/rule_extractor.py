...
from .config import BEIJING_CITY_ID, BEIJING_DISTRICTS
...
class RuleExtractor:
    def extract_spot(
        ...
        if l1["name_zh"] and l1["name_en"]:
            l1["seo_desc"] = f"{l1['name_zh']}({l1['name_en']})北京旅游指南 - 游玩攻略、开放时间、交通路线"
        elif l1["name_zh"]:
            l1["seo_desc"] = f"{l1['name_zh']}北京旅游指南 - 游玩攻略、开放时间、交通路线"
