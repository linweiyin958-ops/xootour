"""Quick test: crawl a few Harbin stores to verify the pipeline works."""
...
from scraper.config import OUTPUT_DIR, DATA_DIR, HARBIN_CITY_ID, HARBIN_DISTRICTS, AMAP_API_KEY
...
logger.info(f"HARBIN_CITY_ID={HARBIN_CITY_ID}")
logger.info(f"Districts: {len(HARBIN_DISTRICTS)}")
