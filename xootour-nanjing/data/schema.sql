-- ============================================================
-- XOOTOUR Nanjing Database Schema
-- 景点系统 + 5大品类门店系统（美食/酒店/景点/购物/娱乐）
-- ============================================================

CREATE DATABASE IF NOT EXISTS `xootour_nanjing` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE `xootour_nanjing`;
...
CREATE TABLE `tour_spot` (
    ...
    `city_id` INT NOT NULL DEFAULT 2 COMMENT '城市ID(南京=2)',
...
(1, '美食', 'Food', 1, '南京美食门店，覆盖淮扬菜/盐水鸭/鸭血粉丝汤/小吃/老字号及各地菜系'),
(2, '酒店', 'Hotel', 2, '南京住宿服务，覆盖星级酒店/温泉民宿/精品酒店/青年旅舍'),
(3, '景点', 'Attraction', 3, '南京旅游景点，覆盖5A/4A景区/博物馆/公园/寺庙/民国建筑/主题乐园'),
(4, '购物', 'Shopping', 4, '南京购物场所，覆盖商圈百货/特色街区/文创市集/特产店'),
(5, '娱乐', 'Entertainment', 5, '南京娱乐场所，覆盖酒吧/KTV/密室/剧本杀/演出/相声/夜店');
