"""Quick test: crawl a few Nanjing stores to verify the pipeline works."""
...
from scraper.config import OUTPUT_DIR, DATA_DIR, NANJING_CITY_ID, NANJING_DISTRICTS, AMAP_API_KEY
...
logger.info(f"NANJING_CITY_ID={NANJING_CITY_ID}")
logger.info(f"Districts: {len(NANJING_DISTRICTS)}")
