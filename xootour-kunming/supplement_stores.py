...
def main():
    parser = argparse.ArgumentParser(description="Batch LLM supplement for Kunming stores")
    ...
    parser.add_argument("--db", type=str, default="output/xootour_kunming.db", help="Database path")
