"""Quick test: crawl a few Kunming stores to verify the pipeline works."""
...
from scraper.config import OUTPUT_DIR, DATA_DIR, KUNMING_CITY_ID, KUNMING_DISTRICTS, AMAP_API_KEY
...
logger.info(f"KUNMING_CITY_ID={KUNMING_CITY_ID}")
logger.info(f"Districts: {len(KUNMING_DISTRICTS)}")
