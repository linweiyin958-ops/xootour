"""Quick test: crawl a few Guangzhou stores to verify the pipeline works."""
...
from scraper.config import OUTPUT_DIR, DATA_DIR, GUANGZHOU_CITY_ID, GUANGZHOU_DISTRICTS, AMAP_API_KEY
...
logger.info(f"GUANGZHOU_CITY_ID={GUANGZHOU_CITY_ID}")
logger.info(f"Districts: {len(GUANGZHOU_DISTRICTS)}")
