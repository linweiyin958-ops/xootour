...
def main():
    parser = argparse.ArgumentParser(description="Batch LLM supplement for Changsha stores")
    ...
    parser.add_argument("--db", type=str, default="output/xootour_changsha.db", help="Database path")
