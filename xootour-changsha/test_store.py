"""Quick test: crawl a few Changsha stores to verify the pipeline works."""
...
from scraper.config import OUTPUT_DIR, DATA_DIR, CHANGSHA_CITY_ID, CHANGSHA_DISTRICTS, AMAP_API_KEY
...
logger.info(f"CHANGSHA_CITY_ID={CHANGSHA_CITY_ID}")
logger.info(f"Districts: {len(CHANGSHA_DISTRICTS)}")
