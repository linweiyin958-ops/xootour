...
class AmapClient:
    ...
    def geocode(self, address: str, city: str = "长沙") -> Optional[dict]:
    ...
    def search_poi(self, keywords: str, city: str = "长沙", citylimit: bool = True) -> Optional[dict]:
        ...
        try:
            ...
            if data.get("status") == "1" and data.get("pois"):
                ...
                return {
                    ...
                    "lat": lat,
                    "lng": lng,
                    "district": poi.get("pname", "") + poi.get("cityname", "").replace("长沙市", ""),
